...
ON_COMMAND(ID_NODE_OP, CbeladrawView::OnNodeOp)
ON_COMMAND(ID_SEGMENT_OP, CbeladrawView::OnSegmentOp)
ON_COMMAND(ID_BLOCK_OP, CbeladrawView::OnBlockOp)
ON_WM_MOUSEMOVE()
ON_COMMAND(ID_ZOOM_IN, CbeladrawView::OnZoomIn)
ON_COMMAND(ID_ZOOM_OUT, CbeladrawView::OnZoomOut)
ON_COMMAND(ID_SHOW_GRID, CbeladrawView::OnShowGrid)
ON_COMMAND(ID_SET_GRID, CbeladrawView::OnSetGrid)
ON_COMMAND(ID_SNAP_GRID, CbeladrawView::OnSnapGrid)
ON_COMMAND(ID_SHOW_MESH, CbeladrawView::OnShowMesh)
ON_COMMAND(ID_EDIT_COPY, CbeladrawView::OnEditCopy)
ON_WM_KEYDOWN()
ON_WM_LBUTTONDBLCLK()
ON_WM_RBUTTONDBLCLK()
ON_COMMAND(ID_ZOOM_NATURAL, CbeladrawView::OnZoomNatural)
ON_COMMAND(ID_ZOOM_WINDOW, CbeladrawView::OnZoomWnd)
ON_WM_LBUTTONDOWN()
ON_WM_LBUTTONUP()
ON_WM_RBUTTONDOWN()
ON_COMMAND(ID_MAKE_MESH, CbeladrawView::OnMakeMesh)
ON_COMMAND(ID_MENU_ANALYZE, CbeladrawView::OnMenuAnalyze)
ON_COMMAND(ID_MENU_VIEWRES, CbeladrawView::OnMenuViewres)
ON_COMMAND(ID_ARCSEG_OP, CbeladrawView::OnArcsegOp)
ON_COMMAND(ID_UNDO, CbeladrawView::OnUndo)
ON_COMMAND(ID_KBDZOOM, CbeladrawView::OnKbdZoom)
ON_COMMAND(ID_MOVE_OBJECTS, CbeladrawView::OnMoveObjects)
ON_COMMAND(ID_COPY_OBJECTS, CbeladrawView::OnCopyObjects)
ON_COMMAND(ID_DXFIN, CbeladrawView::OnDxfin)
ON_COMMAND(ID_PURGEMESH, CbeladrawView::OnPurgemesh)
ON_COMMAND(ID_DXFWRITE, CbeladrawView::OnDxfwrite)
ON_COMMAND(ID_SELECTWND, CbeladrawView::OnSelectwnd)
ON_COMMAND(ID_SELECTCIRC, CbeladrawView::OnBDSelectCirc)
ON_WM_ERASEBKGND()
ON_COMMAND(ID_PAN_DOWN, CbeladrawView::OnPanDown)
ON_COMMAND(ID_PAN_LEFT, CbeladrawView::OnPanLeft)
ON_COMMAND(ID_PAN_RIGHT, CbeladrawView::OnPanRight)
ON_COMMAND(ID_PAN_UP, CbeladrawView::OnPanUp)
ON_COMMAND(ID_MENU_MATLIB, CbeladrawView::OnMenuMatlib)
ON_COMMAND(ID_GROUP_OP, CbeladrawView::OnGroupOp)
ON_COMMAND(ID_OPEN_SELECTED, CbeladrawView::OnOpenSelected)
ON_COMMAND(ID_EDIT_SCALE, CbeladrawView::OnEditScale)
ON_COMMAND(ID_EDIT_MIRROR, CbeladrawView::OnEditMirror)
ON_COMMAND(ID_EDIT_CUT, CbeladrawView::OnEditCut)
ON_COMMAND(ID_EDIT_COPY_AS_METAFILE, CbeladrawView::OnEditCopyAsMetafile)
ON_COMMAND(ID_VIEW_SHOWNAMES, CbeladrawView::OnViewShownames)
ON_COMMAND(ID_VIEW_SHOWORPHANS, CbeladrawView::OnViewShowOrphans)
ON_COMMAND(ID_CREATERADIUS, CbeladrawView::OnCreateRadius)
ON_UPDATE_COMMAND_UI(ID_EDIT_EXTERIOR, CbeladrawView::OnUpdateEditExterior)
//}}AFX_MSG_MAP
